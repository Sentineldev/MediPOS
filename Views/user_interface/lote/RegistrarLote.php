...
if(isset($_POST) && sizeof($_POST) > 0){
    ...
    if(!LoteController::ExisteLote($lote->getNumeroLote())){
        ...
        <div class=" alert alert-danger col-md-10 mt-4 mb-0 m-1" role="alert">
            El Lote ya se encuentra registrado!
        </div>
        ';
    }
    ...
    <section id="main">
        <section id="content">
            ...
            <div id="middle-content" class="container-fluid">
                <h1 id="middle-content-header">Registrar Lote</h1>
                <form method="POST" id="form-container" class="d-flex m-0 pt-1 pb-5">
...
<script type="module">
    <?php
    include('js/lotes/registrar_lote.js');
    ?>
</script>
<script type="module">
    <?php
